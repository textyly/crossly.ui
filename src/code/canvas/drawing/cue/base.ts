...
import { Id, BoundsChangeEvent, Dot, CueSegment, DrawingMode } from "../../types.js";
...
export abstract class CueDrawingCanvasBase extends CanvasBase implements ICueDrawingCanvas {
    ...
    constructor(className: string, cueCanvas: ICueCanvas, vectorDrawing: IVectorDrawingCanvas, drawingMode: DrawingMode) {
        super(className);
