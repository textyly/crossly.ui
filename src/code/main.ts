...
import { ComponentsProvider } from "./menu/components/provider.js";
...
const componentsProvider = new ComponentsProvider(document);
const menuHandler = new MenuHandler(componentsProvider, canvas);
